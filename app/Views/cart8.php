        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php
                     $sql="SELECT * FROM `fashion` ORDER BY `unit_price` ASC";
                     $query   = $db->query($sql);
                    ...
                    <div class="col-md-4">
                      ...
                      <form action="<?php echo site_url("cloth/cart8");?>?id=<?=$row['fashion_id'] ?>" method="post">
                ...
                <div class="col-md-12">
                    ...
                    if(!empty($_SESSION['cart'])){
                        foreach($_SESSION['cart'] as $key => $value){
                            ...
                            <td><a href='cart8?action=remove&id=".$value['id']."'>
