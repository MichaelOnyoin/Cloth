...
<body>
    <div class="dropdown">
  <button class="dropbtn">Cart by Category</button>
  <div class="dropdown-content">
    <a href="cart2">Men</a>
    <a href="cart3">Women</a>
    <a href="#">Children</a>
  </div>
</body>
</html>
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php
                     $sql="SELECT * FROM `fashion` WHERE `category`='Women'";
                     $query   = $db->query($sql);
                    ...
                    <div class="col-md-4">
                      ...
                      <form action="<?php echo site_url("cloth/cart3");?>?id=<?=$row['fashion_id'] ?>" method="post">
                ...
                <div class="col-md-12">
                    ...
                    if(!empty($_SESSION['cart'])){
                        foreach($_SESSION['cart'] as $key => $value){
                            ...
                            <td><a href='cart3?action=remove&id=".$value['id']."'>
